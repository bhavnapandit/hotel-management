...
const FeaturedRoom: FC<Props> = props => {
 ...
 // featuredRoom.images.splice(1, 2).map(image => (console.log(image.url)))
  return <section className='flex md:flex-row flex-col px-4 py-10 items-center gap-12 container mx-auto'>
     <div className='md:grid gap-8 grid-cols-1'>
        ...
        <div className='grid grid-cols-2 gap-8 h-48'>
          {featuredRoom.images.slice(1, 4).map(image => (
