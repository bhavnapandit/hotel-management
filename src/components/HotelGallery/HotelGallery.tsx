...
const HotelGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
        ...
        <div className="hidden md:grid grid-cols-2 h-full gap-5">
          ...
          {remainingPhotosCount > 0 && (
            <div
              ...
              onClick={openModel.bind(this, maxVisiblePhotos)}
            >
              <Image
                width={150}
                height={150}
              ...
              <div className="cursor-pointer absolute text-white inset-0 flex justify-center bg-[rgba(0,0,0,0.5)] items-center text-2xl">
